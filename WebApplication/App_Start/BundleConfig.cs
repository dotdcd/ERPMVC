...
namespace WebApplication
{
    public class BundleConfig
    {
        ...
        {
            RegisterAdmin(bundles);
            RegisterContabilidad(bundles);
            ...
            RegisterSignature(bundles);
            BundleTable.EnableOptimizations = false;
        }

        //? ERP bundles
        private static void RegisterAdmin(BundleCollection bundles)
        {
            bundles.Add(new ScriptBundle("~/Scripts/Admin/Marcas").Include(
                "~/Scripts/Admin/Marcas.js"));
            bundles.Add(new ScriptBundle("~/Scripts/Admin/Marca").Include(
                "~/Scripts/Admin/Marca.js"));
            bundles.Add(new ScriptBundle("~/Scripts/Admin/Proveedor").Include(
                "~/Scripts/Admin/Proveedor.js"));
            bundles.Add(new ScriptBundle("~/Scripts/Admin/Proveedores").Include(
                "~/Scripts/Admin/Proveedores.js"));
            bundles.Add(new ScriptBundle("~/Scripts/Admin/Cables").Include(
                "~/Scripts/Admin/Cables.js"));
            bundles.Add(new ScriptBundle("~/Scripts/Admin/Cable").Include(
                "~/Scripts/Admin/Cable.js"));
            bundles.Add(new ScriptBundle("~/Scripts/Admin/Clientes").Include(
                "~/Scripts/Admin/Clientes.js"));
            bundles.Add(new ScriptBundle("~/Scripts/Admin/Cliente").Include(
                "~/Scripts/Admin/Cliente.js"));
            bundles.Add(new ScriptBundle("~/Scripts/Admin/Disciplinas").Include(
                "~/Scripts/Admin/Disciplinas.js"));
            bundles.Add(new ScriptBundle("~/Scripts/Admin/Disciplina").Include(
                "~/Scripts/Admin/Disciplina.js"));
            bundles.Add(new ScriptBundle("~/Scripts/Admin/Sucursales").Include(
                "~/Scripts/Admin/Sucursales.js"));
            bundles.Add(new ScriptBundle("~/Scripts/Admin/Sucursal").Include(
                "~/Scripts/Admin/Sucursal.js"));
            bundles.Add(new ScriptBundle("~/Scripts/Admin/Dispositivos").Include(
                "~/Scripts/Admin/Dispositivos.js"));
            bundles.Add(new ScriptBundle("~/Scripts/Admin/Dispositivo").Include(
                "~/Scripts/Admin/Dispositivo.js"));

        }

        private static void RegisterContabilidad(BundleCollection bundles)
        {
            bundles.Add(new ScriptBundle("~/Scripts/Contabilidad/Multiempresas").Include(
                "~/Scripts/Contabilidad/Multiempresas.js"));
            bundles.Add(new ScriptBundle("~/Scripts/Contabilidad/Multiempresa").Include(
                "~/Scripts/Contabilidad/Multiempresa.js"));
            bundles.Add(new ScriptBundle("~/Scripts/Contabilidad/Inversiones").Include(
                "~/Scripts/Contabilidad/Inversiones.js"));
            bundles.Add(new ScriptBundle("~/Scripts/Contabilidad/Inversion").Include(
                "~/Scripts/Contabilidad/Inversion.js"));
            bundles.Add(new ScriptBundle("~/Scripts/Contabilidad/Empleados").Include(
                "~/Scripts/Contabilidad/Empleados.js"));
            bundles.Add(new ScriptBundle("~/Scripts/Contabilidad/Empleado").Include(
                "~/Scripts/Contabilidad/Empleado.js"));
        }
        ...
        private static void RegisterForms(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/Scripts/Forms/signature").Include(
                "~/Scripts/Forms/signature.js"));
        ...
        private static void RegisterSignature(BundleCollection bundles)
        {
            bundles.Add(new ScriptBundle("~/Scripts/Signature/signaturepad").Include(
                "~/Scripts/Signature/jquery.signaturepad.js"));
            bundles.Add(new ScriptBundle("~/Scripts/Signature/json2").Include(
                "~/Scripts/Signature/json2.min.js"));
            bundles.Add(new ScriptBundle("~/Scripts/Signature/flashcanvas").Include(
                "~/Scripts/Signature/flashcanvas.js"));

            bundles.Add(new StyleBundle("~/Styles/Signature/signaturepad").Include(
                "~/Styles/Signature/jquery.signaturepad.css"));
        }
        ...
        private static void RegisterCharts(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/Scripts/Charts/Chart").Include(
        ...
        private static void RegisterHome(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/Scripts/Home/MyList").Include(
                "~/Scripts/Home/MyList.js"));
            bundles.Add(new ScriptBundle("~/Scripts/Home/Sample").Include(
                "~/Scripts/Home/Sample.js"));
        }
        ...
        private static void RegisterLayout(BundleCollection bundles)
        {
            ...
            // plugins | datatables
            bundles.Add(new BundleRelaxed("~/AdminLTE/plugins/datatables/js").Include(
                                         ...
                                         //"~/AdminLTE/plugins/datatables/js/datatables.min.js",
                                         "~/AdminLTE/plugins/datatables/js/dataTables.checkboxes.min.js",
            ...
            bundles.Add(new StyleBundle("~/AdminLTE/plugins/datatables/css").Include(
                                 ...
                                 "~/AdminLTE/plugins/datatables/css/buttons.dataTables.min.css",
                                        "~/AdminLTE/plugins/datatables/css/responsive.dataTables.min.css",
                                        "~/AdminLTE/plugins/datatables/css/dataTables.checkboxes.css",
                                        //"~/AdminLTE/plugins/datatables/css/datatables.min.css",
                                        "~/AdminLTE/plugins/datatables/css/select.dataTables.min.css"));
