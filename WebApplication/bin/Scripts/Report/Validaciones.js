...
$(function () {
    ...
    function getData() {
        var table = $('#example2').DataTable({
            ...
            "autoWidth": false,
            "ajax": {
                "url": "/Report/getValidaciones",
                "data": {
                    "prospectoId": function () { return prospectoId },
                    "fecha": function () {
                        if (fecha.length <= 5) {
                            fecha = '1900-01-01';
                        }
            ...
            "columns": [
                ...
                { "data": "prospecto", "autoWidth": true },                
                { "data": "nombreAval", "autoWidth": true },
