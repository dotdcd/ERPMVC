...
$(function () {
    ...
    function getData() {
        var table = $('#example2').DataTable({
            ...
            "autoWidth": false,
            "ajax": {
                "url": "/Report/getServicioExterno",
                "data": {
                    "proveedorId": function () { return proveedorId },
                    "fecha": function () {
                        if (fecha.length <= 5) {
                            fecha = '1900-01-01';
                        }
            ...
            "columns": [
                ...
                { "data": "nomProveedor", "autoWidth": true },
                { "data": "Edificio", "autoWidth": true },
                { "data": "Unidad", "autoWidth": true },
                { "data": "solicitadoPor", "autoWidth": true },                
