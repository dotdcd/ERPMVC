...
namespace WebApplication.Models
{
    ...
    {
        [Required (ErrorMessageResourceType = typeof(Resources), ErrorMessageResourceName = "EmailRequerido")]
        [EmailAddress(ErrorMessage = "Correo incorrecto")]
        [Display(Name = "Email")]
        public string Email { get; set; }

        [Required(ErrorMessageResourceType = typeof(Resources), ErrorMessageResourceName = "PassRequerido")]
        ...
        [Required(ErrorMessageResourceType = typeof(Resources), ErrorMessageResourceName = "UsuarioRequerido")]
